const data = {
    "quizzes": [
        {
            "title": "HTML",
            "icon": `<img src="assets/img/accessibility-img.png" alt="">`,
            "questions": [
                {
        ...
        {
            "title": "CSS",
            "icon": `<img src="assets/img/css-img.png" alt="">`,
            "questions": [
                {
        ...
        {
            "title": "JavaScript",
            "icon": `<img src="assets/img/js-img.png" alt="">`,
            "questions": [
                {
...
for (const x of cards) {
    x.addEventListener("click", function () {
        ...
        ourQuestions = getQuestions(title);
        handleQuestions(ourQuestions);
    });
};


function getQuestions(title) {
    for (const section of data.quizzes) {
...
for (const x of ourQuestions) {
    console.log(x.question);
};

let index = 1;

function handleQuestions(ourQuestions) {
    for (const x of ourQuestions) {
        q.push({
            number: index,
            question: x.question,
...
function renderQuestions() {
    ...
    <p> ${i + 1} of 10 questions </p>
    ${q[i].question}
    ${q[i].choices}
    <button class="submitBtn">Submit</button>   `
    i++;
    const submitBtn = document.querySelector(".submitBtn");
    submitBtn.addEventListener("click", renderQuestions)
}
